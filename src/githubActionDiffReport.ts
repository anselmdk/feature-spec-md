...
.image-comparison-stage{position:relative;display:grid;aspect-ratio:var(--comparison-ratio,16 / 9);background:var(--surface-muted);overflow:hidden;cursor:ew-resize;touch-action:none}
.image-comparison-stage img{display:block;grid-area:1/1;width:100%;height:100%;min-width:0;min-height:0;object-fit:contain;object-position:center;background:var(--surface)}
